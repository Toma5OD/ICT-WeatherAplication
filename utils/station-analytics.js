...
const stationAnalytics = {
  ...
  // Method to return latest reading with use of an if statement.
  ...
  //Get Latest Icon method from code reading.
  ...
  // Get weather status method called GetLatestMain. Calculated from code input.
  ...
  // Convert wind speed to BFT method
  ...
  //Wind direction to string method
  ...
  //Max Temp calculator using if statement and for loop.
  ...
  //Get min temp using if statement and for loop.
  ...
  //Max Wind Speed calculator using if statement and for loop.
  ...
  //Get min Wind Speed using if statement and for loop.
  ...
  //Max Pressure calculator using if statement and for loop.
  ...
  //Min Pressure calculator using if statement and for loop.
